...
public final class Utils {
    ...
    public static List<News> fetchNewsData(String qUrl) {
        ...
        //TODO: There is a change here. Compare with older code
        return fetchResultJson(jsonResponse);
    }


    //TODO: I have changed this method to mine. See how I have done it and make proper edits to avoid plagiarism
    private static List<News> fetchResultJson(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                Log.i("MY TAG------","MY TITLE -----------------------" + newsTitle);
                ...
                News news = new News(newsTitle, newsSection, newsAuthor, newsUrl);
                freshNews.add(news);
            }
